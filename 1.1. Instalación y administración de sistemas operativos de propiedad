...
RAM ---> Requisito ---> 2 GB son necesarios para soportar una instalación completa

SSD ---> Requisito ---> 80 GB para una instalación completa que permita llevar a cabo determinadas tareas
